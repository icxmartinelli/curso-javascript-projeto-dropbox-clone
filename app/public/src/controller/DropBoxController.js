class DropboxController {
    ...
    connectFirebase(){
        ...
        apiKey: "AIzaSyAFeb9TaqZxdkbwQvzvujJp9ttacEshrIM",
        authDomain: "dropbox-clone-c011e.firebaseapp.com",
        databaseURL: "https://dropbox-clone-c011e-default-rtdb.firebaseio.com",
        projectId: "dropbox-clone-c011e",
        storageBucket: "dropbox-clone-c011e.appspot.com",
        messagingSenderId: "44572694391",
        appId: "1:44572694391:web:a353e194b6e11f36ee3372"
        };
    ...
    readFiles(){
        this.getFirebaseRef().on('value', snapshot => {
            ...
            snapshot.forEach(snapshotItem => {
                ...
                let data = (snapshotItem.val()[0] === undefined) ? snapshotItem.val() : snapshotItem.val()[0];
    ...
    initEventsLi(li) {
        this.btnRename.addEventListener('click', e => {
            ...
            let name = prompt("Novo nome de arquivo:", file.originalFilename);
            if (name) {
